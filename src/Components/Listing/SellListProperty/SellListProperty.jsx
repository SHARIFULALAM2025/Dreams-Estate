            ...
            >
              ...
              <div className="flex flex-col justify-between flex-grow p-5 min-w-0">
                <div>
                  ...
                  {/* Location */}
                  <div className="flex items-center gap-1 text-gray-500 dark:text-white text-xs mb-5">
                    <IoLocationOutline className="text-gray-400 dark:text-white flex-shrink-0 w-4 h-4" />
                    ...
                    {propertyFeatures.map((feat, idx) => (
                      ...
                      >
                        ...
                        <div className="min-w-0">
                          <p className="text-[11px] dark:text-white text-gray-400  font-medium truncate">
                            {feat.label[currentLang]}
                          </p>
                          <p className="text-xs font-semibold  text-gray-700 dark:text-white truncate">
                            {feat.value}
                          </p>
                        </div>
                      </div>
...
export default SellListProperty
