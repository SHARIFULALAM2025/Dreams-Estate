...
export const navData = [
  ...
  },
  {
    ...
    subLink: [
      ...
      { id: 542, Name: 'Contact Us', path: '/Contact' },
      { id: 543, Name: 'Testimonial', path: '/Testimonial' },
      { id: 544, Name: 'FAQ', path: '/Faq' },
      { id: 545, Name: 'Pricing', path: '/Pricing' },
      { id: 546, Name: 'Terms & Conditions', path: '/Conditions' },
      { id: 547, Name: 'Privacy Policy', path: '/Policy' },
    ],
  },
]
