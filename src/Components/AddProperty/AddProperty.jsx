...
const AddProperty = () => {
  ...
  const handelData = async (data) => {
    try {
      ...
      // Find city
      const cityObj = stateObj?.upazilas?.find(
        ...
        <form onSubmit={handleSubmit(handelData)} className="space-y-16">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div className="lg:col-span-8 grid grid-cols-1 md:grid-cols-3 gap-6 bg-slate-50/30 dark:bg-slate-900/40 p-6 rounded-2xl border border-slate-100/70 dark:border-slate-800/60">
              ...
              <div>
                <label className="block text-xs font-bold text-slate-700 dark:text-slate-300 mb-2">
                  {currentLang === 'bn' ? 'বেডরুমের সংখ্যা' : 'No of Bedrooms'}
                </label>
                <input
              ...
              <div>
                <label className="block text-xs font-bold text-slate-700 dark:text-slate-300 mb-2">
                  {currentLang === 'bn' ? 'বাথরুমের সংখ্যা' : 'No of Bathrooms'}
                </label>
                <input
                  type="number"
              ...
              <div className="relative md:col-span-2">
                <div className="max-w-[340px]">
                  <label className="block text-xs font-bold text-slate-700 dark:text-slate-300 mb-2">
                    {currentLang === 'bn' ? 'নির্মাণ সাল' : 'Year Constructed'}
                  </label>
                  <div className="relative">
                    <input
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 border-t border-slate-100 dark:border-slate-800 pt-12">
            <div className="lg:col-span-4 space-y-2">
              <h3 className="text-xl font-black text-slate-900 dark:text-white">
                {currentLang === 'bn' ? 'সম্পত্তি সম্পর্কে' : 'About Property'}
              </h3>
              <p className="text-sm text-slate-400 dark:text-slate-500 leading-relaxed">
                {currentLang === 'bn'
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 border-t border-slate-100 dark:border-slate-800 pt-12">
            ...
            <div className="lg:col-span-8 bg-slate-50/30 dark:bg-slate-900/40 p-6 rounded-2xl border border-slate-100/70 dark:border-slate-800/60 space-y-6">
                ...
                >
                  ...
                  {countryData.map((c) => (
                    <option key={c.countryId} value={c.countryId}>
                      {currentLang === 'bn' ? c.countryNameBn : c.countryNameEn}
                    </option>
                  ))}
                </select>
              </div>
              ...
              <div>
                <label className="block text-xs font-bold text-slate-700 dark:text-slate-300 mb-2">
                  {currentLang === 'bn' ? 'রাজ্য / বিভাগ' : 'State / Division'}
                </label>
                <select
                  value={selectedState}
              ...
              <div className="md:col-span-2">
                ...
                >
                  <option value="">
                    {currentLang === 'bn' ? 'শহর নির্বাচন করুন' : 'Select City'}
                  </option>
