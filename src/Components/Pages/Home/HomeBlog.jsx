...
const sliceData=blogs?.slice(0,4) || []
  ...
  return (
    <div className="bg-white py-6 dark:bg-slate-950 min-h-screen  px-4 sm:px-6 lg:px-8 transition-colors duration-300">
      <div className="mb-6 max-w-5xl mx-auto text-center px-4">
        <h1 className="text-slate-900 dark:text-white text-2xl sm:text-3xl md:text-4xl font-bold leading-tight">
          {currentLang === 'bn' ? 'সর্বশেষ ব্লগ' : 'Latest Blog'}
        </h1>

        <p className="mt-3 text-sm sm:text-base md:text-lg text-slate-600 dark:text-slate-300 leading-relaxed">
          {currentLang === 'bn'
            ? 'বিক্রয় ও ভাড়ার জন্য উপলব্ধ সেরা মানের সম্পত্তি বিষয়ক আমাদের বিশেষ ব্লগ পোস্টগুলো দেখুন।'
